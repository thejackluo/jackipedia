...
**Category:** Concepts / Startup Ecosystem
**Summary:** "Nights and Weekends" program where builders build - Jack graduated Season 4
...
This made it closer in philosophy to [[concepts/z-fellows]] (no-equity, bet on the builder) than to [[concepts/y-combinator]] (equity-for-validation, structured). But Buildspace had less external legitimacy as a credential and more as a community.
...
Jack graduated Buildspace Nights and Weekends Season 4. This puts him in the cohort at a specific moment: S4 would have run in 2022 or early 2023, during the period when he was at or transitioning from [[history/georgia-tech-era]], building his early projects, and developing the foundation that became [[projects/agentdex]].
