...
Jack's interest in [[concepts/z-fellows]] specifically, and his general alignment with "bet on the builder, not the credential" cultures, is structurally anti-extractive. The extractive academic credentialing system (only certain degrees from certain schools unlock certain opportunities) is exactly what institutions like Z Fellows and [[concepts/buildspace]] are designed to route around.
