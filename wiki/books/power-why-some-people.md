...
Reading Pfeffer alongside [[books/zero-to-one]] (be contrarian, own your category) and [[books/why-nations-fail]] (inclusive vs. extractive institutions) gives a more complete picture: Pfeffer describes how power works within existing systems; Thiel describes how to build systems that bypass them; Acemoglu and Robinson describe why systems produce different outcomes in the first place.
...
The specific Pfeffer insight most relevant to [[projects/agentdex]]: visibility. Building in public, the waitlist strategy, the organic growth approach - these are visibility plays. Getting 100 emails before the launch, the LinkedIn post, the email blast - Pfeffer would recognize all of these as competent visibility management.
