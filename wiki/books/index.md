...
Jack's reading list is tracked in Notion's "Jotion V4 Media List" database. It covers technical, business, self-improvement, AI, philosophy, fiction, and history. Books are rated 1–5 stars with status (Finished / In Progress / To Read) and Jack's own summaries where provided.

## 5-Star Reads (Exceptional)

| Book | Author | Category | Status |
|------|--------|----------|--------|
| The Courage to Be Disliked | Ichiro Kishimi, Fumitake Koga | Improvement | Finished |
...
**The Power to Compete:** Co-authored by Ryoichi Mikitani (founder of Rakuten), this book is about Japan's struggle to compete globally. Given Jack's Japan affinity and his Asia travel ambitions (Shanghai, Tokyo, Osaka), this is a pointed choice.
...
Detailed pages exist for selected books:
