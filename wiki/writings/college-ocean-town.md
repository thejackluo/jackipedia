# Reflection: A College by an Ocean Town (04/28/24)
**Rating:** 2 Stars
**Date:** April 28, 2024
**Notebook:** Daily/Deep Reflections 2024-2025
...
Jack uses the essay form specifically for place-based writing (this entry, the LA blog). Essays allow more distance and craft than journal entries. The fact that this was published on `thejackluo.notion.site` (his public Notion) along with the LA piece suggests it was meant for an audience.
