...
**Summary:** Jack's relationship with China — heritage, visits, language study, and cultural context
...
In March 2026, China restricted OpenClaw — the AI assistant Jack uses. The restriction is documented in the OpenClaw news archive (`wiki/concepts/openclaw-news.md`).
